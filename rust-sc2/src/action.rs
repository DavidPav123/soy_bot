...
use sc2_proto::{
    ...
    raw::{
        ActionRawUnitCommand_oneof_target as ProtoTarget, ActionRaw_oneof_action as ProtoRawAction,
    },
    ...
    fn from_proto(action: &ProtoAction) -> Self {
        ...
        if action.has_action_raw() {
            match &action.get_action_raw().action {
                ...
                Some(ProtoRawAction::toggle_autocast(toggle_autocast)) => {
                    Some(Action::ToggleAutocast(
                        {
                            let id = toggle_autocast.get_ability_id();
                            AbilityId::from_i32(id).unwrap_or_else(|| {
                                panic!("There's no `AbilityId` with value {}", id)
                            })
                        },
...
impl FromProto<ProtoActionResult> for ActionResult {
    fn from_proto(result: ProtoActionResult) -> Self {
        match result {
            ...
            ProtoActionResult::TransportIsHoldingPosition => {
                ActionResult::TransportIsHoldingPosition
            }
            ProtoActionResult::BuildTechRequirementsNotMet => {
            ...
            ProtoActionResult::CantBuildTooCloseToDropOff => {
            ...
            ProtoActionResult::CantBuildTooCloseToCreepSource => {
                ActionResult::CantBuildTooCloseToCreepSource
            }
            ProtoActionResult::CantBuildTooCloseToResources => {
            ...
            ProtoActionResult::CantBuildTooFarFromCreepSource => {
            ...
            ProtoActionResult::BuildingIsUnderConstruction => {
            ...
            ProtoActionResult::MustTargetWalkableLocation => {
            ...
            ProtoActionResult::YouCantIssueCommandsToThatUnit => {
            ...
            ProtoActionResult::MustTargetEnergyCapableUnits => {
                ActionResult::MustTargetEnergyCapableUnits
            }
            ProtoActionResult::CantTargetEnergyCapableUnits => {
                ActionResult::CantTargetEnergyCapableUnits
            }
            ProtoActionResult::MustTargetShieldCapableUnits => {
                ActionResult::MustTargetShieldCapableUnits
            }
            ProtoActionResult::CantTargetShieldCapableUnits => {
            ...
            ProtoActionResult::MustTargetUnitsInAStasisField => {
                ActionResult::MustTargetUnitsInAStasisField
            }
            ProtoActionResult::CantTargetUnitsInAStasisField => {
            ...
            ProtoActionResult::CantRechargeOtherPlayersUnits => {
            ...
            ProtoActionResult::MustTargetInvulnerableUnits => {
                ActionResult::MustTargetInvulnerableUnits
            }
            ProtoActionResult::CantTargetInvulnerableUnits => {
            ...
            ProtoActionResult::MustTargetUncommandableUnits => {
                ActionResult::MustTargetUncommandableUnits
            }
            ProtoActionResult::CantTargetUncommandableUnits => {
                ActionResult::CantTargetUncommandableUnits
            }
            ProtoActionResult::MustTargetPreventDefeatUnits => {
                ActionResult::MustTargetPreventDefeatUnits
            }
            ProtoActionResult::CantTargetPreventDefeatUnits => {
                ActionResult::CantTargetPreventDefeatUnits
            }
            ProtoActionResult::MustTargetPreventRevealUnits => {
                ActionResult::MustTargetPreventRevealUnits
            }
            ProtoActionResult::CantTargetPreventRevealUnits => {
            ...
            ProtoActionResult::MustTargetUnstoppableUnits => {
                ActionResult::MustTargetUnstoppableUnits
            }
            ProtoActionResult::CantTargetUnstoppableUnits => {
            ...
            ProtoActionResult::CantTargetExhaustedResources => {
