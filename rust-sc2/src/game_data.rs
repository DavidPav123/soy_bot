...
use sc2_proto::{
    data::{
        ...
        BuffData as ProtoBuffData, EffectData as ProtoEffectData,
        UnitTypeData as ProtoUnitTypeData, UpgradeData as ProtoUpgradeData, Weapon as ProtoWeapon,
        Weapon_TargetType,
    },
    sc2api::ResponseData,
};
    ...
    fn from_proto(weapon: &ProtoWeapon) -> Self {
        Self {
            ...
            damage_bonus: weapon
                ...
                .map(|db| {
                    (
                        Attribute::from_proto(db.get_attribute()),
                        db.get_bonus() as u32,
                    )
                })
                .collect(),
