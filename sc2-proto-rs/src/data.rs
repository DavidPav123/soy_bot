...
impl ::protobuf::Message for AbilityData {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<
                _,
                ::protobuf::types::ProtobufTypeEnum<AbilityData_Target>,
            >(
                "target",
...
impl ::protobuf::ProtobufEnum for AbilityData_Target {
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::LazyV2<::protobuf::reflect::EnumDescriptor> =
            ::protobuf::rt::LazyV2::INIT;
        descriptor.get(|| {
            ::protobuf::reflect::EnumDescriptor::new_pb_name::<AbilityData_Target>(
                "AbilityData.Target",
                file_descriptor_proto(),
            )
        })
...
impl ::protobuf::Message for DamageBonus {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<
                _,
                ::protobuf::types::ProtobufTypeEnum<Attribute>,
            >(
                "attribute",
...
impl ::protobuf::Message for Weapon {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<
                _,
                ::protobuf::types::ProtobufTypeEnum<Weapon_TargetType>,
            >(
                "type",
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<DamageBonus>,
                >(
                    "damage_bonus",
...
impl ::protobuf::ProtobufEnum for Weapon_TargetType {
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::LazyV2<::protobuf::reflect::EnumDescriptor> =
            ::protobuf::rt::LazyV2::INIT;
        descriptor.get(|| {
            ::protobuf::reflect::EnumDescriptor::new_pb_name::<Weapon_TargetType>(
                "Weapon.TargetType",
                file_descriptor_proto(),
            )
        })
...
impl ::protobuf::Message for UnitTypeData {
    ...
    fn merge_from(
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                16 => ::protobuf::rt::read_proto2_enum_with_unknown_fields_into(
                    wire_type,
                    is,
                    &mut self.race,
                    16,
                ...
                8 => ::protobuf::rt::read_repeated_enum_with_unknown_fields_into(
                    wire_type,
                    is,
                    &mut self.attributes,
                    8,
    ...
    fn compute_size(&self) -> u32 {
        ...
        for value in &self.tech_alias {
            my_size +=
                ::protobuf::rt::value_size(21, *value, ::protobuf::wire_format::WireTypeVarint);
        }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<Weapon>,
                >(
                    "weapons",
...
impl ::protobuf::ProtobufEnum for Attribute {
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::LazyV2<::protobuf::reflect::EnumDescriptor> =
            ::protobuf::rt::LazyV2::INIT;
        descriptor.get(|| {
            ::protobuf::reflect::EnumDescriptor::new_pb_name::<Attribute>(
                "Attribute",
                file_descriptor_proto(),
            )
        })
