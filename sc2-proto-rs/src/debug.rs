...
impl DebugCommand {
    ...
    pub fn mut_draw(&mut self) -> &mut DebugDraw {
        if let ::std::option::Option::Some(DebugCommand_oneof_command::draw(_)) = self.command {
            ...
            self.command =
                ::std::option::Option::Some(DebugCommand_oneof_command::draw(DebugDraw::new()));
        }
        match self.command {
    ...
    pub fn mut_create_unit(&mut self) -> &mut DebugCreateUnit {
        if let ::std::option::Option::Some(DebugCommand_oneof_command::create_unit(_)) =
            self.command
        {
        } else {
            self.command = ::std::option::Option::Some(DebugCommand_oneof_command::create_unit(
                DebugCreateUnit::new(),
            ));
        }
        match self.command {
    ...
    pub fn mut_kill_unit(&mut self) -> &mut DebugKillUnit {
        if let ::std::option::Option::Some(DebugCommand_oneof_command::kill_unit(_)) = self.command
        {
            ...
            self.command = ::std::option::Option::Some(DebugCommand_oneof_command::kill_unit(
                DebugKillUnit::new(),
            ));
        }
        match self.command {
    ...
    pub fn mut_test_process(&mut self) -> &mut DebugTestProcess {
        if let ::std::option::Option::Some(DebugCommand_oneof_command::test_process(_)) =
            self.command
        {
        } else {
            self.command = ::std::option::Option::Some(DebugCommand_oneof_command::test_process(
    ...
    pub fn mut_score(&mut self) -> &mut DebugSetScore {
        if let ::std::option::Option::Some(DebugCommand_oneof_command::score(_)) = self.command {
            ...
            self.command = ::std::option::Option::Some(DebugCommand_oneof_command::score(
                DebugSetScore::new(),
            ));
        }
        match self.command {
    ...
    pub fn mut_end_game(&mut self) -> &mut DebugEndGame {
        if let ::std::option::Option::Some(DebugCommand_oneof_command::end_game(_)) = self.command {
            ...
            self.command = ::std::option::Option::Some(DebugCommand_oneof_command::end_game(
                DebugEndGame::new(),
            ));
        }
        match self.command {
    ...
    pub fn mut_unit_value(&mut self) -> &mut DebugSetUnitValue {
        if let ::std::option::Option::Some(DebugCommand_oneof_command::unit_value(_)) = self.command
        {
            ...
            self.command = ::std::option::Option::Some(DebugCommand_oneof_command::unit_value(
        ...
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ...
                    self.command = ::std::option::Option::Some(DebugCommand_oneof_command::draw(
                        is.read_message()?,
                    ));
                }
                2 => {
                    ...
                    self.command = ::std::option::Option::Some(
                        DebugCommand_oneof_command::game_state(is.read_enum()?),
                    );
                }
                3 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                    ...
                    self.command = ::std::option::Option::Some(
                        DebugCommand_oneof_command::create_unit(is.read_message()?),
                    );
                }
                4 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                    ...
                    self.command = ::std::option::Option::Some(
                        DebugCommand_oneof_command::kill_unit(is.read_message()?),
                    );
                }
                5 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                    ...
                    self.command = ::std::option::Option::Some(
                        DebugCommand_oneof_command::test_process(is.read_message()?),
                    );
                }
                6 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                ...
                7 => {
                    ...
                    self.command = ::std::option::Option::Some(
                        DebugCommand_oneof_command::end_game(is.read_message()?),
                    );
                }
                8 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                    ...
                    self.command = ::std::option::Option::Some(
                        DebugCommand_oneof_command::unit_value(is.read_message()?),
                    );
                }
                _ => {
        ...
        descriptor.get(|| {
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<DebugText>,
                >(
                    "text",
                    |m: &DebugDraw| &m.text,
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<DebugLine>,
                >(
                    "lines",
                    |m: &DebugDraw| &m.lines,
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<DebugBox>,
                >(
                    "boxes",
                    |m: &DebugDraw| &m.boxes,
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<DebugSphere>,
                >(
                    "spheres",
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(
                ...
                >("p0", |m: &Line| &m.p0, |m: &mut Line| &mut m.p0),
            );
            fields.push(
                ::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<super::common::Point>,
                >("p1", |m: &Line| &m.p1, |m: &mut Line| &mut m.p1),
            );
...
impl ::protobuf::Message for Color {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            >(
                "r", |m: &Color| &m.r, |m: &mut Color| &mut m.r
            ));
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<
                _,
                ::protobuf::types::ProtobufTypeUint32,
            >(
                "g", |m: &Color| &m.g, |m: &mut Color| &mut m.g
            ));
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<
                _,
                ::protobuf::types::ProtobufTypeUint32,
            >(
                "b", |m: &Color| &m.b, |m: &mut Color| &mut m.b
            ));
...
impl DebugText {
    ...
    pub fn get_color(&self) -> &Color {
        self.color
            .as_ref()
            .unwrap_or_else(|| <Color as ::protobuf::Message>::default_instance())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<Color>,
                >(
                    "color",
                    |m: &DebugText| &m.color,
...
impl DebugLine {
    ...
    pub fn get_line(&self) -> &Line {
        self.line
            .as_ref()
            .unwrap_or_else(|| <Line as ::protobuf::Message>::default_instance())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<Line>,
                >(
                    "line",
                    |m: &DebugLine| &m.line,
        ...
        descriptor.get(|| {
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<super::common::Point>,
                >("min", |m: &DebugBox| &m.min, |m: &mut DebugBox| &mut m.min),
            );
            fields.push(
                ::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<super::common::Point>,
                >("max", |m: &DebugBox| &m.max, |m: &mut DebugBox| &mut m.max),
            );
        ...
        descriptor.get(|| {
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<super::common::Point>,
                >("p", |m: &DebugSphere| &m.p, |m: &mut DebugSphere| &mut m.p),
            );
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<
                _,
...
impl ::protobuf::Message for DebugTestProcess {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<
                _,
                ::protobuf::types::ProtobufTypeEnum<DebugTestProcess_Test>,
            >(
                "test",
...
impl ::protobuf::ProtobufEnum for DebugTestProcess_Test {
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::LazyV2<::protobuf::reflect::EnumDescriptor> =
            ::protobuf::rt::LazyV2::INIT;
        descriptor.get(|| {
            ::protobuf::reflect::EnumDescriptor::new_pb_name::<DebugTestProcess_Test>(
...
impl ::protobuf::Message for DebugEndGame {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<
                _,
                ::protobuf::types::ProtobufTypeEnum<DebugEndGame_EndResult>,
            >(
                "end_result",
...
impl ::protobuf::ProtobufEnum for DebugEndGame_EndResult {
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::LazyV2<::protobuf::reflect::EnumDescriptor> =
            ::protobuf::rt::LazyV2::INIT;
        descriptor.get(|| {
            ::protobuf::reflect::EnumDescriptor::new_pb_name::<DebugEndGame_EndResult>(
...
impl DebugSetUnitValue {
    ...
    pub fn get_unit_value(&self) -> DebugSetUnitValue_UnitValue {
        self.unit_value
            .unwrap_or(DebugSetUnitValue_UnitValue::Energy)
    }
    pub fn clear_unit_value(&mut self) {
...
impl ::protobuf::Message for DebugSetUnitValue {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<
                _,
                ::protobuf::types::ProtobufTypeEnum<DebugSetUnitValue_UnitValue>,
            >(
                "unit_value",
...
impl ::protobuf::ProtobufEnum for DebugSetUnitValue_UnitValue {
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::LazyV2<::protobuf::reflect::EnumDescriptor> =
            ::protobuf::rt::LazyV2::INIT;
        descriptor.get(|| {
            ::protobuf::reflect::EnumDescriptor::new_pb_name::<DebugSetUnitValue_UnitValue>(
...
impl ::protobuf::ProtobufEnum for DebugGameState {
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::LazyV2<::protobuf::reflect::EnumDescriptor> =
            ::protobuf::rt::LazyV2::INIT;
        descriptor.get(|| {
            ::protobuf::reflect::EnumDescriptor::new_pb_name::<DebugGameState>(
                "DebugGameState",
                file_descriptor_proto(),
            )
        })
