...
impl RequestQuery {
    ...
    pub fn mut_abilities(
        &mut self,
    ) -> &mut ::protobuf::RepeatedField<RequestQueryAvailableAbilities> {
        &mut self.abilities
    }
    ...
    // Mutable pointer to the field.
    pub fn mut_placements(
        &mut self,
    ) -> &mut ::protobuf::RepeatedField<RequestQueryBuildingPlacement> {
        &mut self.placements
    }
        ...
        descriptor.get(|| {
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<RequestQueryPathing>,
                >(
                    "pathing",
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<RequestQueryAvailableAbilities>,
                >(
                    "abilities",
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<RequestQueryBuildingPlacement>,
                >(
                    "placements",
...
impl ResponseQuery {
    ...
    pub fn mut_abilities(
        &mut self,
    ) -> &mut ::protobuf::RepeatedField<ResponseQueryAvailableAbilities> {
        &mut self.abilities
    }
    ...
    pub fn mut_placements(
        &mut self,
    ) -> &mut ::protobuf::RepeatedField<ResponseQueryBuildingPlacement> {
        &mut self.placements
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<ResponseQueryPathing>,
                >(
                    "pathing",
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<ResponseQueryAvailableAbilities>,
                >(
                    "abilities",
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<ResponseQueryBuildingPlacement>,
                >(
                    "placements",
...
impl RequestQueryPathing {
    ...
    pub fn mut_start_pos(&mut self) -> &mut super::common::Point2D {
        if let ::std::option::Option::Some(RequestQueryPathing_oneof_start::start_pos(_)) =
            self.start
        {
        } else {
            self.start = ::std::option::Option::Some(RequestQueryPathing_oneof_start::start_pos(
        ...
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ...
                    self.start = ::std::option::Option::Some(
                        RequestQueryPathing_oneof_start::start_pos(is.read_message()?),
                    );
                }
                2 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                    ...
                    self.start = ::std::option::Option::Some(
                        RequestQueryPathing_oneof_start::unit_tag(is.read_uint64()?),
                    );
                }
                3 => {
...
impl ::protobuf::Message for ResponseQueryPathing {
    ...
    fn default_instance() -> &'static ResponseQueryPathing {
        static instance: ::protobuf::rt::LazyV2<ResponseQueryPathing> =
            ::protobuf::rt::LazyV2::INIT;
...
impl ::protobuf::Message for RequestQueryAvailableAbilities {
    ...
    fn default_instance() -> &'static RequestQueryAvailableAbilities {
        static instance: ::protobuf::rt::LazyV2<RequestQueryAvailableAbilities> =
            ::protobuf::rt::LazyV2::INIT;
...
impl ::protobuf::Message for ResponseQueryAvailableAbilities {
    ...
    fn default_instance() -> &'static ResponseQueryAvailableAbilities {
        static instance: ::protobuf::rt::LazyV2<ResponseQueryAvailableAbilities> =
            ::protobuf::rt::LazyV2::INIT;
...
impl ::protobuf::Message for RequestQueryBuildingPlacement {
    ...
    fn default_instance() -> &'static RequestQueryBuildingPlacement {
        static instance: ::protobuf::rt::LazyV2<RequestQueryBuildingPlacement> =
            ::protobuf::rt::LazyV2::INIT;
...
impl ::protobuf::Message for ResponseQueryBuildingPlacement {
    ...
    fn default_instance() -> &'static ResponseQueryBuildingPlacement {
        static instance: ::protobuf::rt::LazyV2<ResponseQueryBuildingPlacement> =
            ::protobuf::rt::LazyV2::INIT;
