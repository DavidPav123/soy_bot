...
impl StartRaw {
    ...
    pub fn get_pathing_grid(&self) -> &super::common::ImageData {
        self.pathing_grid.as_ref().unwrap_or_else(|| {
    ...
    pub fn get_terrain_height(&self) -> &super::common::ImageData {
        self.terrain_height.as_ref().unwrap_or_else(|| {
            <super::common::ImageData as ::protobuf::Message>::default_instance()
        })
    }
    ...
    pub fn get_placement_grid(&self) -> &super::common::ImageData {
        self.placement_grid.as_ref().unwrap_or_else(|| {
            <super::common::ImageData as ::protobuf::Message>::default_instance()
        })
    }
    ...
    pub fn get_playable_area(&self) -> &super::common::RectangleI {
        self.playable_area.as_ref().unwrap_or_else(|| {
            <super::common::RectangleI as ::protobuf::Message>::default_instance()
        })
    }
    ...
    pub fn take_playable_area(&mut self) -> super::common::RectangleI {
        self.playable_area
            .take()
            .unwrap_or_else(|| super::common::RectangleI::new())
    }
    ...
    // Mutable pointer to the field.
    pub fn mut_start_locations(
        &mut self,
    ) -> &mut ::protobuf::RepeatedField<super::common::Point2D> {
...
impl ObservationRaw {
    ...
    pub fn get_player(&self) -> &PlayerRaw {
        self.player
            .as_ref()
            .unwrap_or_else(|| <PlayerRaw as ::protobuf::Message>::default_instance())
    }
    ...
    pub fn get_map_state(&self) -> &MapState {
        self.map_state
            .as_ref()
            .unwrap_or_else(|| <MapState as ::protobuf::Message>::default_instance())
    }
    ...
    pub fn get_event(&self) -> &Event {
        self.event
            .as_ref()
            .unwrap_or_else(|| <Event as ::protobuf::Message>::default_instance())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<PlayerRaw>,
                >(
                    "player",
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<Unit>,
                >(
                    "units",
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<MapState>,
                >(
                    "map_state",
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<Effect>,
                >(
                    "effects",
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<RadarRing>,
                >(
                    "radar",
...
impl RadarRing {
    ...
    pub fn get_pos(&self) -> &super::common::Point {
        self.pos
            .as_ref()
            .unwrap_or_else(|| <super::common::Point as ::protobuf::Message>::default_instance())
    }
    ...
    pub fn take_pos(&mut self) -> super::common::Point {
        self.pos
            .take()
            .unwrap_or_else(|| super::common::Point::new())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<super::common::Point>,
                >(
                    "pos",
                    |m: &RadarRing| &m.pos,
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<PowerSource>,
                >(
                    "power_sources",
...
impl UnitOrder {
    ...
    pub fn mut_target_world_space_pos(&mut self) -> &mut super::common::Point {
        if let ::std::option::Option::Some(UnitOrder_oneof_target::target_world_space_pos(_)) =
            self.target
        {
        } else {
            self.target = ::std::option::Option::Some(
                UnitOrder_oneof_target::target_world_space_pos(super::common::Point::new()),
            );
        }
        match self.target {
            ::std::option::Option::Some(UnitOrder_oneof_target::target_world_space_pos(
                ref mut v,
            )) => v,
            _ => panic!(),
        }
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ...
                    self.target = ::std::option::Option::Some(
                        UnitOrder_oneof_target::target_world_space_pos(is.read_message()?),
                    );
                }
                3 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                    ...
                    self.target = ::std::option::Option::Some(
                        UnitOrder_oneof_target::target_unit_tag(is.read_uint64()?),
                    );
                }
                4 => {
                    if wire_type != ::protobuf::wire_format::WireTypeFixed32 {
...
impl ::protobuf::Message for Unit {
    ...
    fn compute_size(&self) -> u32 {
        ...
        for value in &self.buff_ids {
            my_size +=
                ::protobuf::rt::value_size(27, *value, ::protobuf::wire_format::WireTypeVarint);
        }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<
                _,
                ::protobuf::types::ProtobufTypeEnum<DisplayType>,
            >(
                "display_type",
            ...
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<
                _,
                ::protobuf::types::ProtobufTypeEnum<Alliance>,
            >(
                "alliance",
                |m: &Unit| &m.alliance,
            ...
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<
                ...
                ::protobuf::types::ProtobufTypeUint64,
            >(
                "tag", |m: &Unit| &m.tag, |m: &mut Unit| &mut m.tag
            ));
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<
                _,
                ::protobuf::types::ProtobufTypeUint32,
            ...
            >(
                "owner", |m: &Unit| &m.owner, |m: &mut Unit| &mut m.owner
            ));
            fields.push(
                ::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<super::common::Point>,
                >("pos", |m: &Unit| &m.pos, |m: &mut Unit| &mut m.pos),
            );
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<
                _,
                ::protobuf::types::ProtobufTypeFloat,
            ...
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<
                _,
                ::protobuf::types::ProtobufTypeEnum<CloakState>,
            >(
                "cloak", |m: &Unit| &m.cloak, |m: &mut Unit| &mut m.cloak
            ));
            fields.push(::protobuf::reflect::accessor::make_vec_accessor::<
                _,
                ::protobuf::types::ProtobufTypeUint32,
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<UnitOrder>,
                >("orders", |m: &Unit| &m.orders, |m: &mut Unit| &mut m.orders),
            );
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<
                _,
                ::protobuf::types::ProtobufTypeUint64,
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<PassengerUnit>,
                >(
                    "passengers",
                    |m: &Unit| &m.passengers,
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<RallyTarget>,
                >(
                    "rally_targets",
...
impl MapState {
    ...
    pub fn get_visibility(&self) -> &super::common::ImageData {
        self.visibility.as_ref().unwrap_or_else(|| {
            <super::common::ImageData as ::protobuf::Message>::default_instance()
        })
    }
        ...
        descriptor.get(|| {
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<super::common::Point2D>,
                >("pos", |m: &Effect| &m.pos, |m: &mut Effect| &mut m.pos),
            );
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<
                _,
                ::protobuf::types::ProtobufTypeEnum<Alliance>,
...
impl ActionRaw {
    ...
    pub fn mut_unit_command(&mut self) -> &mut ActionRawUnitCommand {
        if let ::std::option::Option::Some(ActionRaw_oneof_action::unit_command(_)) = self.action {
            ...
            self.action = ::std::option::Option::Some(ActionRaw_oneof_action::unit_command(
    ...
    pub fn mut_camera_move(&mut self) -> &mut ActionRawCameraMove {
        if let ::std::option::Option::Some(ActionRaw_oneof_action::camera_move(_)) = self.action {
            ...
            self.action = ::std::option::Option::Some(ActionRaw_oneof_action::camera_move(
    ...
    pub fn mut_toggle_autocast(&mut self) -> &mut ActionRawToggleAutocast {
        if let ::std::option::Option::Some(ActionRaw_oneof_action::toggle_autocast(_)) = self.action
        {
            ...
            self.action = ::std::option::Option::Some(ActionRaw_oneof_action::toggle_autocast(
            ...
            match field_number {
                1 => {
                    ...
                    self.action = ::std::option::Option::Some(
                        ActionRaw_oneof_action::unit_command(is.read_message()?),
                    );
                }
                2 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                ...
                3 => {
                    ...
                    self.action = ::std::option::Option::Some(
                        ActionRaw_oneof_action::toggle_autocast(is.read_message()?),
                    );
                }
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(
...
impl ActionRawUnitCommand {
    ...
    pub fn has_target_world_space_pos(&self) -> bool {
        match self.target {
            ::std::option::Option::Some(
                ActionRawUnitCommand_oneof_target::target_world_space_pos(..),
            ) => true,
            _ => false,
        }
    }
    ...
    pub fn set_target_world_space_pos(&mut self, v: super::common::Point2D) {
        self.target = ::std::option::Option::Some(
            ActionRawUnitCommand_oneof_target::target_world_space_pos(v),
        )
    }
    ...
    pub fn mut_target_world_space_pos(&mut self) -> &mut super::common::Point2D {
        if let ::std::option::Option::Some(
            ActionRawUnitCommand_oneof_target::target_world_space_pos(_),
        ) = self.target
        {
        } else {
            self.target = ::std::option::Option::Some(
        ...
        match self.target {
            ::std::option::Option::Some(
                ActionRawUnitCommand_oneof_target::target_world_space_pos(ref mut v),
            ) => v,
            _ => panic!(),
        }
    }
    ...
    pub fn has_target_unit_tag(&self) -> bool {
        match self.target {
            ::std::option::Option::Some(ActionRawUnitCommand_oneof_target::target_unit_tag(..)) => {
                true
            }
            _ => false,
        }
    ...
    pub fn set_target_unit_tag(&mut self, v: u64) {
        self.target =
            ::std::option::Option::Some(ActionRawUnitCommand_oneof_target::target_unit_tag(v))
    }
...
impl ::protobuf::Message for ActionRawUnitCommand {
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                3 => {
                    ...
                    self.target = ::std::option::Option::Some(
                        ActionRawUnitCommand_oneof_target::target_unit_tag(is.read_uint64()?),
                    );
                }
                4 => {
    ...
    fn default_instance() -> &'static ActionRawUnitCommand {
        static instance: ::protobuf::rt::LazyV2<ActionRawUnitCommand> =
            ::protobuf::rt::LazyV2::INIT;
...
impl ::protobuf::Message for ActionRawToggleAutocast {
    ...
    fn default_instance() -> &'static ActionRawToggleAutocast {
        static instance: ::protobuf::rt::LazyV2<ActionRawToggleAutocast> =
            ::protobuf::rt::LazyV2::INIT;
...
impl ::protobuf::ProtobufEnum for DisplayType {
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::LazyV2<::protobuf::reflect::EnumDescriptor> =
            ::protobuf::rt::LazyV2::INIT;
        descriptor.get(|| {
            ::protobuf::reflect::EnumDescriptor::new_pb_name::<DisplayType>(
                "DisplayType",
                file_descriptor_proto(),
            )
        })
...
impl ::protobuf::ProtobufEnum for Alliance {
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::LazyV2<::protobuf::reflect::EnumDescriptor> =
            ::protobuf::rt::LazyV2::INIT;
        descriptor.get(|| {
            ::protobuf::reflect::EnumDescriptor::new_pb_name::<Alliance>(
                "Alliance",
                file_descriptor_proto(),
            )
        })
...
impl ::protobuf::ProtobufEnum for CloakState {
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::LazyV2<::protobuf::reflect::EnumDescriptor> =
            ::protobuf::rt::LazyV2::INIT;
        descriptor.get(|| {
            ::protobuf::reflect::EnumDescriptor::new_pb_name::<CloakState>(
                "CloakState",
                file_descriptor_proto(),
            )
        })
