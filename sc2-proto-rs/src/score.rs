...
impl Score {
    ...
    pub fn get_score_details(&self) -> &ScoreDetails {
        self.score_details
            .as_ref()
            .unwrap_or_else(|| <ScoreDetails as ::protobuf::Message>::default_instance())
    }
    ...
    pub fn take_score_details(&mut self) -> ScoreDetails {
        self.score_details
            .take()
            .unwrap_or_else(|| ScoreDetails::new())
    }
}
...
impl ::protobuf::Message for Score {
    ...
    fn merge_from(
        ...
        while !is.eof()? {
            ...
            match field_number {
                6 => ::protobuf::rt::read_proto2_enum_with_unknown_fields_into(
                    wire_type,
                    is,
                    &mut self.score_type,
                    6,
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_option_accessor::<
                _,
                ::protobuf::types::ProtobufTypeEnum<Score_ScoreType>,
            >(
                "score_type",
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<ScoreDetails>,
                >(
                    "score_details",
...
impl ::protobuf::ProtobufEnum for Score_ScoreType {
    ...
    fn values() -> &'static [Self] {
        static values: &'static [Score_ScoreType] =
            &[Score_ScoreType::Curriculum, Score_ScoreType::Melee];
        values
    }
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::LazyV2<::protobuf::reflect::EnumDescriptor> =
            ::protobuf::rt::LazyV2::INIT;
        descriptor.get(|| {
            ::protobuf::reflect::EnumDescriptor::new_pb_name::<Score_ScoreType>(
                "Score.ScoreType",
                file_descriptor_proto(),
            )
        })
...
impl ::protobuf::Message for CategoryScoreDetails {
    ...
    fn default_instance() -> &'static CategoryScoreDetails {
        static instance: ::protobuf::rt::LazyV2<CategoryScoreDetails> =
            ::protobuf::rt::LazyV2::INIT;
...
impl ScoreDetails {
    ...
    pub fn get_food_used(&self) -> &CategoryScoreDetails {
        self.food_used
            .as_ref()
            .unwrap_or_else(|| <CategoryScoreDetails as ::protobuf::Message>::default_instance())
    }
    ...
    pub fn take_food_used(&mut self) -> CategoryScoreDetails {
        self.food_used
            .take()
            .unwrap_or_else(|| CategoryScoreDetails::new())
    }
    ...
    pub fn get_total_damage_dealt(&self) -> &VitalScoreDetails {
        self.total_damage_dealt
            .as_ref()
            .unwrap_or_else(|| <VitalScoreDetails as ::protobuf::Message>::default_instance())
    }
    ...
    pub fn take_total_damage_dealt(&mut self) -> VitalScoreDetails {
        self.total_damage_dealt
            .take()
            .unwrap_or_else(|| VitalScoreDetails::new())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<CategoryScoreDetails>,
                >(
                    "food_used",
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<VitalScoreDetails>,
                >(
                    "total_damage_dealt",
